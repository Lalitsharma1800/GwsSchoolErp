      ...
      <div
        ...
        <div className="flex items-center gap-2 ">
          ...
          <div className="flex items-center gap-6 ">
            ...
            {/* Navigation menu */}
            {!isMobile && (
              <NavigationMenu className="flex  ml-10">
        ...
        <div className="flex items-center gap-0.5">
             ...
             <button  
             className="text-sm font-medium hover:bg-neutral-300 rounded-full p-1 hover:text-accent-foreground cursor-pointer"
             >
                
                
                <Avatar>
                  <AvatarImage src="https://github.com/shadcn.png" />
                  <AvatarFallback className="bg-black text-white ">UN</AvatarFallback>
                </Avatar>
             </button>
