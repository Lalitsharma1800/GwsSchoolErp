...
function ERPFooter(){
    return(
         <footer className="bg-white">
          ...
          <div className="text-neutral-600 flex flex-col medium:flex-row gap-15  md:justify-around mt-10 mx-3 smallMobile:mx-10 2xl:mx-0 2xl:justify-center max-w-1850px">
            <ul className="">
